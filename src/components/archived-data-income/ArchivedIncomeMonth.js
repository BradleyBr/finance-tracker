...
export default class ArchivedIncomeMonth extends React.Component {
    ...
    defaultState() {
        return this.setState({activeJanuary: false, activeFebruary: false, activeMarch: false, activeApril: false, activeMay: false, activeJune: false, activeJuly: false,
                            activeAugust: false, activeSeptember: false, activeOctober: false, activeNovember: false, activeDecember: false})
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                {!this.state.activeJanuary ? null : <ArchivedIncomePage props={propsData.January} />}
                {!this.state.activeFebruary ? null : <ArchivedIncomePage props={propsData.February} />}
                {!this.state.activeMarch ? null : <ArchivedIncomePage props={propsData.March} />}
                {!this.state.activeApril ? null : <ArchivedIncomePage props={propsData.April} />}
                {!this.state.activeMay ? null : <ArchivedIncomePage props={propsData.May} />}
                {!this.state.activeJune ? null : <ArchivedIncomePage props={propsData.June} />}
                {!this.state.activeJuly ? null : <ArchivedIncomePage props={propsData.July} />}
                {!this.state.activeAugust ? null : <ArchivedIncomePage props={propsData.August} />}
                {!this.state.activeSeptember ? null : <ArchivedIncomePage props={propsData.September} />}
                {!this.state.activeOctober ? null : <ArchivedIncomePage props={propsData.October} />}
                {!this.state.activeNovember ? null : <ArchivedIncomePage props={propsData.November} />}
                {!this.state.activeDecember ? null : <ArchivedIncomePage props={propsData.December} />}
            </div>
        )
    }
}