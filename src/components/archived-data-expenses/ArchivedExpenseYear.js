...
export default class ArchivedExpensePage extends React.Component {
    ...
    // On click function for each year in the archive, reset state to close other pages 
    defaultState() {
        return (this.setState({active2019: false, active2020: false, active2021: false, active2022: false, active2023: false, active2024: false, active2025: false,
                            active2026: false, active2027: false, active2028: false, active2029: false, active2030: false, active2031: false,
                            active2032: false, active2033: false, active2034: false}))
    }
    onClick(e) {
        this.defaultState()
    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className="archive-expense-month-container">
                    {!this.state.active2019 ? null : <ArchivedExpenseMonth props={propsData[2019]} />}
                    {!this.state.active2020 ? null : <ArchivedExpenseMonth props={propsData[2020]} />}
                    {!this.state.active2021 ? null : <ArchivedExpenseMonth props={propsData[2021]} />}
                    {!this.state.active2022 ? null : <ArchivedExpenseMonth props={propsData[2022]} />}
                    {!this.state.active2023 ? null : <ArchivedExpenseMonth props={propsData[2023]} />}
                    {!this.state.active2024 ? null : <ArchivedExpenseMonth props={propsData[2024]} />}
                    {!this.state.active2025 ? null : <ArchivedExpenseMonth props={propsData[2025]} />}
                    {!this.state.active2026 ? null : <ArchivedExpenseMonth props={propsData[2026]} />}
                    {!this.state.active2027 ? null : <ArchivedExpenseMonth props={propsData[2027]} />}
                    {!this.state.active2028 ? null : <ArchivedExpenseMonth props={propsData[2028]} />}
                    {!this.state.active2029 ? null : <ArchivedExpenseMonth props={propsData[2029]} />}
                    {!this.state.active2030 ? null : <ArchivedExpenseMonth props={propsData[2030]} />}
                    {!this.state.active2031 ? null : <ArchivedExpenseMonth props={propsData[2031]} />}
                    {!this.state.active2032 ? null : <ArchivedExpenseMonth props={propsData[2032]} />}
                    {!this.state.active2033 ? null : <ArchivedExpenseMonth props={propsData[2033]} />}
                    {!this.state.active2034 ? null : <ArchivedExpenseMonth props={propsData[2034]} />}
                </div>
